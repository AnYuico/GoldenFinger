...
$projectPath = Join-Path $repoRoot "src\GameToolOrchestrator.ConsoleRunner\GameToolOrchestrator.ConsoleRunner.csproj"
$publishRoot = Join-Path $repoRoot "artifacts\publish"
$outputDirectory = Join-Path $publishRoot "GameToolOrchestrator.ConsoleRunner-$Runtime"
$exePath = Join-Path $outputDirectory "GameToolOrchestrator.ConsoleRunner.exe"
...
Write-Host "Publishing GameToolOrchestrator.ConsoleRunner"
...
try {
    ...
    Invoke-Step "dotnet publish ConsoleRunner" {
